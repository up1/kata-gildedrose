...
public class GildedRoseTest {
    ...
    @Test public void
    aged_brie_item_before_sale_date() {
    ...
    @Test public void
    aged_brie_item_before_sale_date_with_max_quality() {
    ...
    @Test public void
    aged_brie_item_after_sale_date() {
        GildedRose gildedRose = new GildedRose("Aged Brie", 10, -5);
        gildedRose.updateQuality();
        assertEquals(12, gildedRose.getQuality());
    }
    ...
    @Test public void
    aged_brie_item_after_sale_date_with_max_quality() {
        GildedRose gildedRose = new GildedRose("Aged Brie", 50, -5);
        gildedRose.updateQuality();
        assertEquals(50, gildedRose.getQuality());
    }
    ...
    @Test public void
    sulfuras_item_before_sale_date() {
    ...
    @Test public void
    sulfuras_item_after_sale_date2() {
    ...
    @Test public void
    backstage_passes_item_long_before_sale_date() {
    ...
    @Test public void
    backstage_pass_medium_close_to_sell_date_upper_bound() {
    ...
    @Test public void
    backstage_pass_medium_close_to_sell_date_lower_bound() {
    ...
    @Test public void
    backstage_pass_medium_close_to_sell_date_lower_bound_with_max_quality() {
    ...
    @Test public void
    backstage_pass_medium_close_to_sell_date_lower_bound_with_max_quality2() {
    ...
    @Test public void
    backstage_pass_very_close_to_sell_date_upper_bound_with_max_quatity() {
    ...
    @Test public void
    backstage_pass_very_close_to_sell_date_upper_bound_with_max_quatity2() {
    ...
    @Test public void
    backstage_pass_item_on_sale_date() {
    ...
    @Test public void
    backstage_pass_item_after_sale_date() {
        GildedRose gildedRose = new GildedRose("Backstage passes to a TAFKAL80ETC concert", 10, -5);
        gildedRose.updateQuality();
        assertEquals(0, gildedRose.getQuality());
    }
    ...
    @Test public void
    conjured_item_before_sale_date() {
    ...
    @Test public void
    conjured_item_before_sale_date_with_zero_quality() {
    ...
    @Test public void
    conjured_item_on_sale_date_with_zero_quality() {
    ...
    @Test public void
    conjured_item_after_sale_date_with_zero_quality() {
        GildedRose gildedRose = new GildedRose("Conjured", 0, -5);
        gildedRose.updateQuality();
        assertEquals(0, gildedRose.getQuality());
    }
